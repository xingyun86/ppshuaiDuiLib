...
protected:
	LRESULT DoVerb(LONG iVerb);

	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled);
	LRESULT OnTimer(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled);
	LRESULT OnMouseActivate(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled);
	LRESULT OnSetFocus(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled);
	LRESULT OnKillFocus(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled);
	LRESULT OnEraseBkgnd(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled);
	LRESULT OnPaint(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled);
	LRESULT OnPrint(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled);
...
LRESULT CActiveXWnd::OnFinalMessage(HWND hWnd)
{
...
LRESULT CActiveXWnd::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled)
{
...
LRESULT CActiveXWnd::OnTimer(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled)
{
...
LRESULT CActiveXWnd::OnEraseBkgnd(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled)
{
    if ( m_pOwner->m_pViewObject == NULL ) bHandled = (-1L);
    return (1L);
}

LRESULT CActiveXWnd::OnMouseActivate(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled)
{
    IOleObject* pUnk = NULL;
    m_pOwner->m_pOwner->GetControl(IID_IOleObject, (LPVOID*) &pUnk);
...
LRESULT CActiveXWnd::OnSetFocus(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled)
{
    bHandled = (-1L);
...
LRESULT CActiveXWnd::OnKillFocus(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled)
{
    bHandled = (-1L);
...
LRESULT CActiveXWnd::OnPaint(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled)
{
    PAINTSTRUCT ps = { 0 };
...
LRESULT CActiveXWnd::OnPrint(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled)
{
	RECT rcClient;
...
LRESULT CActiveXUI::SetPos(RECT rc, BOOL bNeedInvalidate)
{
    CControlUI::SetPos(rc, bNeedInvalidate);

    if ( !m_bCreated ) DoCreateControl();

    if ( m_pUnk == NULL ) return (-1L);
    if ( m_pControl == NULL ) return (-1L);
...
LRESULT CActiveXUI::Move(SIZE szOffset, BOOL bNeedInvalidate)
{
...
LRESULT CActiveXUI::DoPaint(HDC hDC, const RECT& rcPaint, CControlUI* pStopControl)
{
...
LRESULT CActiveXUI::MessageHandler(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& bHandled)
{
    ...
    if ( (uMsg >= WM_MOUSEFIRST && uMsg <= WM_MOUSELAST) || uMsg == WM_SETCURSOR ) {
        ...
        if ( uMsg == WM_SETCURSOR ) bWasHandled = (-1L);
...
LRESULT CActiveXUI::CreateControl(LPCTSTR pstrCLSID)
{
    CLSID clsid = { 0 };
...
LRESULT CActiveXUI::CreateControl(const CLSID clsid)
{
    ASSERT(clsid!=IID_NULL);
    if ( clsid == IID_NULL ) return (-1L);
    m_bCreated = false;
    m_clsid = clsid;
...
LRESULT CActiveXUI::ReleaseControl()
{
    m_hwndHost = NULL;
    if ( m_pUnk != NULL ) {
...
LRESULT CActiveXUI::DoCreateControl()
{
    ReleaseControl();
